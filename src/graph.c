...
void draw_hyperbola(float a, float b, Color col)
{
    ...
    Vector2 P1 = {centerX + 36 * a * 2, centerY + 36 * b * sqrt(3)};
    Vector2 P2 = {centerX + 2 / 3 * 36 * a, centerY + 36 * b * (48 - 26 * sqrt(3)) / 18};
    Vector2 P3 = {centerX + 2 / 3 * 36 * a, centerY - 36 * b * (48 - 26 * sqrt(3)) / 18};
    Vector2 P4 = {centerX + 36 * 2 * a, centerY - 36 * b * sqrt(3)};
    Vector2 El = {centerX + 20 * 18, centerY + 20 * (b / a) * 15};
    Vector2 El2 = {centerX + 20 * 18, centerY - 20 * (b / a) * 15};
    DrawLineBezierCubic(P1, P4, P2, P3, 2.0f, col);
    DrawLineEx(P1, El, 2.0f, col);
    DrawLineEx(P4, El2, 2.0f, col);

    Vector2 q1 = {centerX - 36 * a * 2, centerY + 36 * b * sqrt(3)};
    Vector2 q2 = {centerX - 2 / 3 * 36 * a, centerY + 36 * b * (48 - 26 * sqrt(3)) / 18};
    Vector2 q3 = {centerX - 2 / 3 * 36 * a, centerY - 36 * b * (48 - 26 * sqrt(3)) / 18};
    Vector2 q4 = {centerX - 36 * 2 * a, centerY - 36 * b * sqrt(3)};
    Vector2 Eql = {centerX - 20 * 18, centerY + 20 * (b / a) * 15};
    Vector2 Eql2 = {centerX - 20 * 18, centerY - 20 * (b / a) * 15};
